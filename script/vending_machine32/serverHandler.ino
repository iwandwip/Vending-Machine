int checkRFID(String UID_rfid) {
        ...
        if (statusWifi == 1) {
                ...
                Serial.println("httpReqRFID = " + String(httpRequestData));
...
int ageCheck(String UID_rfid) {
        int a = 0;
        String httpRequestData = String(DOMAIN)
                                 + String("/api/purchase/check_umur.php?rfid=")
                                 + String(UID_rfid);
        ...
        if (statusWifi == 1) {
                ...
                int httpResponseCode = http.GET();
                String payload = http.getString();
                Serial.println("httpReqUmur = " + String(httpRequestData));
...
int GetID(String UID_rfid) {
        int a = 0;
        String httpRequestData = String(DOMAIN)
                                 + String("/api/purchase/get_id.php?rfid=")
                                 + String(UID_rfid);
